...
lemma one_leq_c1rho : 1 ≤ ↑(h7.cρ q hq0 h2mq) := by
  ...
  cases' H with h1 h2
  · apply (h7.c₁neq0); exact h1.1
  · apply (h7.c₁neq0); exact h2.1
...
lemma c1rho_neq_0 : h7.c1ρ q hq0 h2mq ≠ 0 := by
  ...
  cases' H1 with h1 h2
  · apply cρ_ne_zero h7 q hq0 h2mq; exact h1
...
lemma crho_abs_eq : |h7.c₁ ^ h7.r q hq0 h2mq * h7.c₁ ^ (2 * h7.m * q)| =
  h7.c₁ ^ h7.r q hq0 h2mq * h7.c₁ ^ (2 * h7.m * q) := by
    rw [abs_eq_self]
    apply mul_nonneg
    · apply pow_nonneg; exact le_trans Int.one_nonneg h7.one_leq_c₁
    · apply pow_nonneg; exact le_trans Int.one_nonneg h7.one_leq_c₁
