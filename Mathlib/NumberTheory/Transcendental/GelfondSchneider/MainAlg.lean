...
/- A parameter `n` dependent on a free parameter `q`. -/
def n : ℕ := q ^ 2 / (2 * h7.m)
...
lemma c1a0 : IsIntegral ℤ (h7.c₁ ^ (a q t * h7.l q u) • (h7.α' ^ (a q t * h7.l q u))) := by
  apply h7.c₁ac h7.α' (a q t) (h7.l q u) (a q t) (h7.l q u) (by rfl) (by grind [h7.isIntegral_c₁α])

lemma c1c0 : IsIntegral ℤ (h7.c₁ ^ (b q t * h7.l q u) • (h7.γ'^ (b q t * (h7.l q u)))) := by
  apply h7.c₁ac h7.γ' (b q t) (h7.l q u) (b q t) (h7.l q u) (by rfl) (by grind [h7.isIntegral_c₁γ])

open Nat in include hq0 in
lemma c1a : IsIntegral ℤ (h7.c₁^(h7.m * q) • (h7.α' ^ (a q t * h7.l q u))) := by
  refine h7.c₁ac h7.α' (h7.m) q (a q t) (h7.l q u) ?_ (by grind [h7.isIntegral_c₁α])
  · rw [mul_comm]
...
lemma c1c : IsIntegral ℤ (h7.c₁ ^ (h7.m * q) • (h7.γ'^ (b q t * h7.l q u))) := by
  refine h7.c₁ac h7.γ' (h7.m) q (b q t) (h7.l q u) ?_ (by grind [h7.isIntegral_c₁γ])
  · rw [mul_comm]
    exact Nat.mul_le_mul (add_le_of_le_sub (le_of_ble_eq_true rfl)
...
lemma one_le_n : 1 ≤ h7.n q := by
  simpa [n] using
    (Nat.one_le_div_iff (by positivity [h7.one_le_m])).2 (Nat.le_of_dvd (Nat.pow_pos hq0) h2mq)
...
lemma c₁IsInt (u : Fin (h7.m * h7.n q)) (t : Fin (q * q)) :
  ...
  rw [zsmul_triple_comm, mul_assoc]
  refine IsIntegral.mul ?_ (IsIntegral.mul (h7.c1a q hq0 u t) (h7.c1c q hq0 u t))
...
lemma c₁c_ne_zero : h7.c₁ • h7.γ' ≠ 0 := by
  ...
  · simp only [c₃, mul_assoc]
    ...
    · have h1 : 1 ≤ (1 + house h7.β') := by
      ...
      have h3 : 1 ≤ ((sqrt ((2 * h7.m)))) := by
         rw [one_le_sqrt]
         apply le_trans (mod_cast Nat.zero_lt_succ (2 * h7.h + 1))
           (le_mul_of_one_le_left (by simp) (one_le_two))
...
lemma q_eq_n_etc : q ^ (h7.n q - 1) ≤ (sqrt (2 * h7.m) ^ (h7.n q - 1)) * (sqrt (h7.n q)) ^
  ...
  have hq : (q : ℝ) ≤ sqrt (2 * h7.m * h7.n q) := by
    refine (le_sqrt (by positivity) (by positivity)).2 (mod_cast h7.sq_le_two_mn q h2mq)
...
lemma fracmqn : ((h7.m : ℝ) * (h7.n q : ℝ) / (2 * (h7.m : ℝ) * (h7.n q : ℝ) -
  ...
  refine ⟨Ne.symm (Nat.zero_ne_add_one (2 * h7.h + 1)), Nat.ne_zero_of_lt (h7.one_le_n q hq0 h2mq)⟩
...
lemma hfrac : (h7.n q : ℝ) * (h7.n q : ℝ) ^ (((h7.n q : ℝ) - 1) / 2) = (h7.n q : ℝ) ^
  ...
  · congr; ring
  · norm_cast
    grind [Nat.ne_zero_of_lt (h7.one_le_n q hq0 h2mq)]
...
lemma hAkl : house ((algebraMap (𝓞 h7.K) h7.K) ((h7.A q) hq0 h2mq u t)) ≤
    ...
    · apply mul_le_mul ?_ ?_ (by positivity) (by positivity)
      ...
      · apply Bound.pow_le_pow_right_of_le_one_or_one_le
            (Or.inl ⟨one_le_house_of_isIntegral h7.isIntegral_c₁γ h7.c₁c_ne_zero, ?_⟩)
        · rw [mul_comm h7.m q]
        ...
        · calc _ ≤ house (h7.c₁ • h7.α') ^ (h7.m * (2 * (h7.m * h7.n q))) := ?_
          ...
          · have house_alg_int_le_pow (α : h7.K) (n m : ℕ) (h : n ≤ m) (hα0 : α ≠ 0)
            ...
            refine house_alg_int_le_pow (h7.c₁ • h7.α') (h7.m * q) (h7.m * (2 * (h7.m * h7.n q)))
              ?_ h7.c₁α_ne_zero h7.isIntegral_c₁α
      ...
      · calc _ ≤ house (h7.c₁ • h7.γ') ^ (h7.m * (2 * (h7.m * h7.n q))) := ?_
        ...
        · have house_alg_int_le_pow (α : h7.K) (n m : ℕ) (h : n ≤ m) (hα0 : α ≠ 0)
          ...
          refine house_alg_int_le_pow (h7.c₁ • h7.γ') (h7.m * q)
            (h7.m * (2 * (h7.m * h7.n q))) ?_ h7.c₁c_ne_zero h7.isIntegral_c₁γ
...
abbrev η : Fin (q * q) → 𝓞 h7.K :=
  ...
  (h7.hM_ne_zero q hq0 h2mq) (mul_pos (Nat.zero_lt_succ (2 * h7.h + 1)) (h7.one_le_n q hq0 h2mq))
  (h7.hmn q hq0 h2mq) (Fintype.card_fin _) (fun u t ↦ h7.hAkl q hq0 u t h2mq)
...
lemma fromlemma82_bound : house (algebraMap (𝓞 h7.K) h7.K (h7.η q hq0 h2mq t)) ≤
  ...
  · exact mod_cast ((NumberField.house.exists_ne_zero_int_vec_house_le
    h7.K (h7.A q hq0 h2mq) (h7.hM_ne_zero q hq0 h2mq) (mul_pos (Nat.zero_lt_succ (2 * h7.h + 1))
    (h7.one_le_n q hq0 h2mq)) (h7.hmn q hq0 h2mq) (Fintype.card_fin _)
    (fun u t ↦ h7.hAkl q hq0 u t h2mq) (Fintype.card_fin _)).choose_spec).2.2 t
