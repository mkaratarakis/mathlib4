...
Accompanying paper: the local–global step, in its sharpest form. -/
...
Accompanying paper: the local–global principle for `R[θ] = S`. -/
...
Accompanying paper: membership detected by the localisations. -/
...
Accompanying paper: monogenity is a local property — the local approach named in the title. -/
...
Accompanying paper: the converse direction: monogenity descends to the localisations. -/
